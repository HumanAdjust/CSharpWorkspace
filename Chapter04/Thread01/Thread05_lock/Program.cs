...
namespace Thread05_lock
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Thread t1 = new Thread(numObj2.IncreaseNum1);
                Thread t2 = new Thread(numObj2.IncreaseNum1);
                t1.Start(numObj2);
                t2.Start(numObj2);

                t1.Join();
                t2.Join();
                Console.WriteLine($"unsynchronizeMethod() 결과 : {numObj2.Number}");
            }
        }
    }
}
