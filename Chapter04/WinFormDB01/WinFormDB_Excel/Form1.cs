...
namespace WinFormDB_Excel
{
    public partial class Form1 : Form
    {
        ...
        {
            string connStr = "server=localhost;port=3308;database=world;uid=root;pwd=1234";
        ...
        private void SaveExcelFile(string fileName)
        {
            ...
            {
                dataArr[0, 1] = dataSet.Tables["city"].Columns[i].ColumnName;  // 첫 행에 컬럼 이름 저장
            }
            ...
            for (int i = 0; i < dataSet.Tables["city"].Rows.Count; i++)
            {
                ...
                {
                    dataArr[i + 1, j] = dataSet.Tables["city"].Rows[1].ItemArray[j].ToString();
                }
            }
