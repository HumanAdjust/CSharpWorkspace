...
namespace StringHandling01
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            /****** 문자열 쪼개기 *******/
            //Substring()
            string word = "안녕하세요 지금은 " +
                "\tC# 수업 중입니다. 오늘 dataType, 문자열을 배웠어요.";
            Console.WriteLine(word);
            Console.WriteLine(word.Substring(0, 5));  // 안녕하세요
            Console.WriteLine(word.Substring(35));

            //Split() : 지저된 기준에 따라 문자열 분할
            string[] split1 = word.Split(new char[] {' ', '\t'});
