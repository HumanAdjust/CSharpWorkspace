...
namespace GenericConstraint
{
    ...
    class RefArray<T> where T : class // T는 참조 형식이여야 함
    {
        public T[] Array { get; set; }
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            a.Array[1] = 1;
            a.Array[2] = 2;
            //StructArray<StructArray<int>> b = new StructArray<StructArray<int>>(3);
        ...
        public static T CreateInstance<T>() where T : new()  // T는 기본 생성자가 있어야 한다.
        {
            return new T();
        }// T는 기본생성자가 있어야 한다.
    }
